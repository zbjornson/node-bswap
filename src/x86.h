...
public:
	...
	static inline void swap(void* addr, Vec128 mask) {
...
public:
	__m256i v;
	static constexpr uint8_t size() { return 32; }
	...
	static inline void swap(void* addr, Vec256 mask) {
...
public:
	__m512i v;
	static constexpr uint8_t size() { return 64; }
	...
	static inline void swap(void* addr, Vec512 mask) {
		__m512i v = _mm512_load_si512(addr);
		v = _mm512_shuffle_epi8(v, mask.v);
		_mm512_store_si512(addr, v);
	}
};
